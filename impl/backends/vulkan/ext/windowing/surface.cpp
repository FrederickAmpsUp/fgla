...
SurfaceImpl::SurfaceImpl(WindowImpl& window, const fgla::Instance& instance) {
  ...
  this->instance = dynamic_cast<InstanceImpl *>(fgla::internal::ImplAccessor::get_impl(instance))->get_instance();
  VkResult res = glfwCreateWindowSurface(
    this->instance,
    window.get_window(), nullptr, &this->surface
  );
